...
function Search() {
    ...
    const handleKeyPress = (event) => {
        console.log("2232",event.target.value,"22332232",inputValue)
        // setInputValue(event.target.value)
        // if (event.key === 'Enter') {
        //     router.push("/dashboard/user/test")
        // }
    };
        ...
        <div className='search'>
            <div className='searchCard' style={showList ? visibleStyle : null}>
                <div className="form" >
                    ...
                    <input className="input" onBlur={onBlur} placeholder="Type your text"  onClick={handleInputClick}
